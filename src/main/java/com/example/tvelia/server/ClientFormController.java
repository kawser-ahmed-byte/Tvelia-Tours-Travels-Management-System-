...
import static com.example.tvelia.server.LoginClientFormController.username;
...
public class ClientFormController extends Thread {
    ...
    public HBox hboxmessage = new HBox();
    public VBox vboxmessage = new VBox();
    public Label userFN;
    ...
    public void initialize() {
        ...
        txtClientMessage.setStyle("-fx-prompt-text-fill: white; -fx-background-color: transparent");
    }
...
//        txtClientPane.appendText("Me: " + msg + "\n");
    ...
    public void chooseImageOnAction(ActionEvent mouseEvent) throws Exception {
